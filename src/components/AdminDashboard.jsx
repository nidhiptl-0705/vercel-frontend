...
// Removed Salary import
import AdminAttendance from './dashboard/AdminAttendance';
import Settings from './dashboard/Settings';
import AdminEodReports from './dashboard/AdminEodReports';
import GeofenceConfig from './GeofenceConfig';
import GPSAttendanceDashboard from './GPSAttendanceDashboard';
...
const AdminDashboard = ({ user, setIsAuthenticated }) => {
  ...
  const tabs = [
    ...
    { id: 'gps-dashboard', name: 'GPS Dashboard', icon: '🗺️' },
    { id: 'leave', name: 'Leave Management', icon: '📅' },
    { id: 'eods', name: 'EOD Reports', icon: '📝' },
    { id: 'geofence', name: 'GPS Locations', icon: '📍' },
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'gps-dashboard':
        return <GPSAttendanceDashboard />;
      case 'leave':
        return <LeaveManagement />;
      case 'eods':
        return <AdminEodReports />;
      case 'geofence':
